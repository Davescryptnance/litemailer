                ...
                <td valign="top" style="padding:0;Margin:0;">
                                ...
                                <table class="es-header-body"
                                    ...
                                    <tr style="border-collapse:collapse;">
                                        <td align="left" bgcolor="transparent"
                                            style="Margin:0;padding-top:35px;padding-left:35px;padding-right:35px;padding-bottom:40px;background-color:transparent;">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                <tr style="border-collapse:collapse;">
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We built this email sending app during a Laravel
                                                                        Lessons <a target="_blank"
                                                                            ...
                                                                            href="http://stephenjude.me/series/laravel-lessons">blog
                                                                            series</a> and someone just sent out a bulk
                                                                        email via the&nbsp;app.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;">
                                                                        <strong>Here is the message:</strong></p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0;"><img
                                                                        src="https://ifcztd.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/18501522065897895.png"
                                                                        alt
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center"
                        ...
                        <tr style="border-collapse:collapse;">
                            <td align="center" style="padding:0;Margin:0;">
                                <table class="es-content-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#1B9BA3;border-bottom:10px solid #48AFB5;"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:30px;Margin:0;">
                                                                    <h2
                                                                        style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#FEFAFA;">
                                                                        LiteMailer</h2>
                                                                </td>
                                                            </tr>
                                                        </table>
